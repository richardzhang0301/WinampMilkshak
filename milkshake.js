...
var milk = (function(){
    ...
    req.open("GET", "LocalAudio.js", false); req.send(); eval(req.responseText);
    ...
    function shake(elementId, audioUrl) {
    ...
    function getShaker() { return typeof shaker !== 'undefined' ? shaker : null; }
    function getAudio() { return typeof audio !== 'undefined' ? audio : null; }
    ...
    return {shake: shake, getShaker: getShaker, getAudio: getAudio};
